  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Angel&apos;s Nest has been a cherished family-run retreat.
            Started by our grandparents, this haven has been nurtured with love
            and care, passing down through our family as a testament to our
            dedication to creating a warm, welcoming environment.
          </p>
          <p>
            Over the years, we&apos;ve maintained the essence of The Angel&apos;s Nest, blending the timeless beauty of the mountains with the
            personal touch only a family business can offer. Here, you&apos;re
            not just a guest; you&apos;re part of our extended family. So join
            us at The Angel&apos;s Nest soon, where tradition meets tranquility, and every visit is like coming home.
          </p>
